...
flowchart TD
  ...
  %% Habit Loop
  D2 --> E{User Activity?}
  E -- Streak --> F1[Push: You’re on a streak! \u{1F4AA}]
  E -- Comeback --> F2[Push: Let’s bounce back \u{1F501}]
  E -- New/Restart --> F3[Push: Let’s get started \u{1F4AA}]
  E -- No Workout --> F4[Push: Log your activity \u{1F4DD}]

  %% Cancellation
  E --> G{User Cancelled?}
  G -- Yes --> H1[Push: 1h Post-Cancel Win-Back \u{1F501}]
